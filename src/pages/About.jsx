      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-white mb-6">
            Built for <span className="neon-text">Creators</span>,<br />
            by Creators
          </h1>
          ...
          {[
            {
              icon: Target,
              title: "Our Mission",
              desc: "Democratize access to premium media tools. Every creator deserves professional-grade tools without the professional price tag.",
              color: "#00f5ff",
            },
            {
              icon: Zap,
              title: "Our Vision",
              desc: "A world where creators spend time creating, not fighting with tools. We handle the technical complexity so you can focus on your craft.",
              color: "#bf00ff",
            },
            {
              icon: Heart,
              title: "Our Values",
              desc: "Privacy-first, creator-focused, and always improving. We listen to our community and ship new features every week.",
              color: "#ff0080",
            },
          ].map((item, i) => (
            <motion.div
