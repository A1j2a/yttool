    ...
    <PageWrapper>
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        ...
        <ol className="list-decimal list-inside space-y-3 text-slate-300 mb-8">
          ...
          <li>
            Select your preferred audio quality (128kbps, 192kbps, or 256kbps).
          </li>
          <li>
            Click <strong className="text-white">Convert to MP3</strong> and
            wait a few seconds.
          </li>
          <li>
            Hit <strong className="text-white">Download MP3</strong> — done!
          </li>
        </ol>
          ...
          {[
            {
              ...
              a: "Converting YouTube videos for personal, offline use is generally accepted. Do not distribute copyrighted content.",
            },
            {
              q: "What quality is the MP3?",
              a: "You can choose from 128kbps, 192kbps, or 256kbps. Higher quality means larger file size.",
            },
            {
